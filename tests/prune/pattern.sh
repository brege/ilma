...
run_command --workdir "$repository_root" "$repository_root/ilma" prune --pattern '*.pyc' "$project_path"
assert_exit 0
assert_contains "$COMMAND_STDOUT" "Pattern: *.pyc"
assert_contains "$COMMAND_STDOUT" "Found 42 items"
