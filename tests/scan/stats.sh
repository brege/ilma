...
run_command --workdir "$repository_root" "$repository_root/commands/scan.sh" --type python --stats=excludes "$project_path"
assert_exit 0
assert_contains "$COMMAND_STDOUT" "Found prunables:"
